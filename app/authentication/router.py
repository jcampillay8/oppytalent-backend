...
from app.authentication.schemas import (
    UsuarioPublicSchema, ForgotPasswordSchema, ResetPasswordSchema, LoginResponseSchema, ImpersonateRequestSchema
)
...
def get_cookie_settings(request: Request):
    ...
    return {
        "samesite": "none", # Cambiado a 'none' porque Front y Back están en distintos subdominios de Railway
        "secure": True 
    }
...
async def login(
    ...
    # Agregamos manualmente los campos que no están en el modelo Usuario de la DB
...
async def refresh_token(
    ...
    try:
        ...
        new_access_token = create_access_token(
            user.email, 
            impersonated_role_id=impersonated_role_id,
